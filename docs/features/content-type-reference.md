...
BOOK support currently provides processor-owned reading, persistent locators, partial progress, continue behavior, and child consumption state. EPUB is the first built-in format processor. Offline downloads, merge/migration, previews, immersive feeds, Local-source import, and tracking have not been added for BOOK yet.
