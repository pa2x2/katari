...
For extensions distributed through Katari's public repository, follow the contribution and release workflow in [`katari-extensions`](https://github.com/pa2x2/katari-extensions).
