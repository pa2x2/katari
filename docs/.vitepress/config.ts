...
const base = "/katari/";
const repositoryUrl = "https://github.com/pa2x2/katari";
    ...
    items: [
      {
        ...
        link: "/features/content-type-reference",
      },
      ...
      {
        text: "Extensions and compatibility",
        link: "/differences/extensions-and-compatibility",
      },
      {
        text: "Builds, telemetry, and privacy",
        link: "/differences/builds-telemetry-and-privacy",
      },
    ],
  },
  {
    ...
    items: [
      { text: "Developer documentation", link: "/developers/" },
      {
        ...
        items: [
          ...
          {
            text: "Migrating from Mihon",
            link: "/extensions/migrating-from-mihon",
          },
          {
            text: "Publishing and maintenance",
            link: "/extensions/publishing",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "Compatibility and versioning",
            link: "/developers/sdk/versioning",
          },
          {
            text: "Local SDK development",
            link: "/developers/sdk/local-development",
          },
...
export default defineConfig({
  ...
  sitemap: {
    hostname: "https://pa2x2.github.io/katari/",
  },
  markdown: {
    config(md) {
      md.core.ruler.after("inline", "github-mentions", (state) => {
        ...
        const mentionPattern =
          /(?<![\w.+-])@([a-z\d](?:[a-z\d-]{0,37}[a-z\d])?)(?![a-z\d-])/gi;
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        link: "/about-project",
        activeMatch:
          "^/(about-project|migrating-to-katari|troubleshooting|inherited-features|differences/backup-and-restore)",
      },
      {
        text: "Features",
        link: "/features/content-type-reference",
        activeMatch:
          "^/(features|differences/(extensions-and-compatibility|builds-telemetry-and-privacy))/",
      },
      {
        text: "Developers",
        link: "/developers/",
        activeMatch: "^/(developers|extensions)/",
      },
    ],
    sidebar,
    outline: {
    ...
    editLink: {
      pattern: "https://github.com/pa2x2/katari/edit/main/docs/:path",
      text: "Edit this page on GitHub",
    },
    socialLinks: [
      {
        icon: "github",
        link: "https://github.com/pa2x2/katari",
        ariaLabel: "Katari on GitHub",
      },
    ],
    docFooter: {
      prev: "Previous page",
