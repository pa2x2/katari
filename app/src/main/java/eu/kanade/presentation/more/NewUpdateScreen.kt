...
fun NewUpdateScreen(
    ...
    InfoScreen(
        ...
        acceptText = when (stage) {
            ...
            NewUpdateScreenModel.Stage.Downloading -> downloadProgress()?.let { progress ->
                stringResource(MR.strings.downloading_with_progress, progress)
            } ?: stringResource(MR.strings.update_check_notification_download_in_progress)
